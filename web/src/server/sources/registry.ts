...
export const SOURCES: SourceConfig[] = [
  ...
  },
  {
    ...
    type: "github",
    url: "https://api.github.com/search/repositories?q=topic:mcp-server&sort=updated&order=desc",
    weight: 5,
    layer: "builder",
  },
  {
    ...
    type: "github",
    url: "https://api.github.com/search/repositories?q=topic:model-context-protocol&sort=updated&order=desc",
    weight: 5,
    layer: "builder",
  },
  {
    ...
    type: "github",
    url: "https://api.github.com/search/repositories?q=topic:ai-agent&sort=updated&order=desc",
    weight: 5,
    layer: "builder",
  },
  {
    ...
    type: "github",
    url: "https://api.github.com/search/repositories?q=topic:llm&sort=updated&order=desc",
    weight: 4,
    layer: "builder",
  },
  {
  ...
  },
  {
    ...
    type: "github",
    url: "https://api.github.com/search/repositories?q=topic:github-actions+topic:llm&sort=updated&order=desc",
    weight: 4,
    layer: "builder",
  },
  {
